...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //TODO (04) Create an observer on viewModel.regionList. Override the required //DONE
        // onChanged() method to include the following changes.
        viewModel.regionList.observe(viewLifecycleOwner, object: Observer<List<String>> {
            override fun onChanged(data: List<String>?) {
               data?: return // if data is null return immediately

                //TODO (05) Create a new layoutInflator from the ChipGroup.
                val chipGroup = binding.regionList
                val inflator = LayoutInflater.from(chipGroup.context)

                //TODO (06) Use the map() function to create a Chip for each item in regionList and //DONE
                ...
                //TODO (07) Call chipGroup.removeAllViews() to remove any views already in chipGroup. //DONE
                chipGroup.removeAllViews()

                //TODO (08)  Iterate through the list of children and add each chip to chipGroup. //DONE
